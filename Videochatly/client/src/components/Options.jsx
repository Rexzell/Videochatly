        ...
        <form className={classes.root} noValidate autoComplete="off">
          ...
          <Grid container className={classes.gridContainer}>
            <Grid item xs={12} md={6} className={classes.padding}>
              <Typography gutterBottom variant="h6">Account:</Typography>
            ...
            <Grid item xs={12} md={6} className={classes.padding}>
              ...
              <TextField label="Paste Friend ID to Call" value={idToCall} onChange={(e) => setIdToCall(e.target.value)} fullWidth />
